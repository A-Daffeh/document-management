...
import com.adoustar.documentmanagement.domain.TokenData;
import com.adoustar.documentmanagement.domain.dto.User;
import com.adoustar.documentmanagement.enums.TokenType;
import com.adoustar.documentmanagement.function.TriConsumer;
import com.adoustar.documentmanagement.security.JwtConfiguration;
...
public class JwtServiceImpl extends JwtConfiguration implements JwtService {
    ...
    private final BiFunction<User, TokenType, String> buildToken = (user, tokenType) ->
             Objects.equals(tokenType, TokenType.ACCESS) ? builder.get().subject(user.getUserId())
                     ...
                     .compact() : builder.get().subject(user.getUserId())
                     .expiration(Date.from(Instant.now().plusSeconds(getExpiration())))
                     .compact();
